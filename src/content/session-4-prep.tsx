          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.number} className="flex gap-4 items-start">
                <div className="w-7 h-7 rounded-full bg-[#8B79D4]/20 border border-[#8B79D4]/30 flex items-center justify-center text-[#8B79D4] text-xs font-bold flex-shrink-0 mt-0.5">
                  {item.number}
                </div>
                <div>
