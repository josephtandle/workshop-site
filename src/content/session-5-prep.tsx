      ...
      <div className="space-y-6">
        ...
        >
          ...
          <ol className="space-y-3 list-decimal list-inside">
            <li>
              Go to{' '}
              <a href="https://chatgpt.com" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline font-medium">
                chatgpt.com
              </a>
              {' '}and log in
            </li>
        ...
        >
          ...
          <ol className="space-y-3 list-decimal list-inside">
            <li>
              Go to{' '}
              <a href="https://claude.ai/settings/data-privacy-controls" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline font-medium">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-white/[0.06] border border-white/[0.10] hover:border-[#8B79D4]/40 text-[#FCF4EB]/80 text-sm px-4 py-2 rounded-xl transition-colors"
            >
              App Store (iPhone)
            </a>
            <a
        ...
        >
          <p>
            ...
            <a href="https://resend.com" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline">
              Resend
            </a>{' '}
          ...
          <div className="space-y-3">
            <div className="bg-white/[0.04] border border-white/[0.08] rounded-xl p-4">
              ...
              <p className="text-[#FCF4EB]/60 text-sm leading-relaxed">
                ...
                <a href="https://resend.com/domains" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline">
                  Resend Domains
                </a>{' '}
