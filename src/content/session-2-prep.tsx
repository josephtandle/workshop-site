    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="mb-10">
        ...
        <p className="text-[#FCF4EB]/70 text-base sm:text-lg leading-relaxed mb-6">
          Complete these three steps before the session. Total time: about 15 minutes.
      ...
      <div className="space-y-6">
        ...
        >
          <p>
            ...
            that puts your website on the internet. At the end of the session, you will run one command
