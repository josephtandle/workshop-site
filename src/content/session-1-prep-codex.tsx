      ...
      <div className="space-y-6">
        ...
        >
          ...
          <ol className="space-y-3 list-decimal list-inside">
            <li>
              Go to{' '}
              <a href="https://chat.openai.com" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline font-medium">
                chat.openai.com
              </a>
            </li>
        ...
        >
          ...
          <ol className="space-y-3 list-decimal list-inside">
            <li>
              Go to{' '}
              <a href="https://vercel.com/signup" target="_blank" rel="noopener noreferrer" className="text-[#8B79D4] hover:underline font-medium">
                vercel.com/signup
              </a>
            </li>
            <li>
