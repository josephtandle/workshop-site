...
export const metadata = {
  title: "Session 9 Guide: Joe's Magic CRM Installation",
  description: 'Open up a terminal, start Claude with dangerously skip permissions, install the All Sorted CRM module into Mission Control, and finish the live CRM setup.',
}
