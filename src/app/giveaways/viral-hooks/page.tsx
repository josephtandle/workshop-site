...
const REELS = [
  { id: 'DA0k_aYMnhp', url: 'https://www.instagram.com/reel/DA0k_aYMnhp/' },
  { id: 'DSPBxlviPtK', url: 'https://www.instagram.com/reel/DSPBxlviPtK/' },
  { id: 'DFfc26Lsqog', url: 'https://www.instagram.com/reel/DFfc26Lsqog/' },
  { id: 'DF2sqPkN2hU', url: 'https://www.instagram.com/reel/DF2sqPkN2hU/' },
  { id: 'DKaoC1hubgG', url: 'https://www.instagram.com/reel/DKaoC1hubgG/' },
  { id: 'DTO27ZBjsnl', url: 'https://www.instagram.com/reel/DTO27ZBjsnl/' },
  { id: 'DWmYXSxD5GP', url: 'https://www.instagram.com/reel/DWmYXSxD5GP/' },
  { id: 'DO_bXsdDVLb', url: 'https://www.instagram.com/reel/DO_bXsdDVLb/' },
  { id: 'DL5q6Y7SIbt', url: 'https://www.instagram.com/reel/DL5q6Y7SIbt/' },
  { id: 'DNCYiJORxhz', url: 'https://www.instagram.com/reel/DNCYiJORxhz/' },
  { id: 'DXHmcQ0jOLW', url: 'https://www.instagram.com/reel/DXHmcQ0jOLW/' },
  { id: 'DUK9fD4jAJB', url: 'https://www.instagram.com/reel/DUK9fD4jAJB/' },
  { id: 'DUq0XYrjIit', url: 'https://www.instagram.com/reel/DUq0XYrjIit/' },
  { id: 'DVjWQ_vD3pt', url: 'https://www.instagram.com/reel/DVjWQ_vD3pt/' },
  { id: 'DXJALeKyacj', url: 'https://www.instagram.com/reel/DXJALeKyacj/' },
  { id: 'DT0rS32CLA-', url: 'https://www.instagram.com/reel/DT0rS32CLA-/' },
  { id: 'DNhCJ0ghS36', url: 'https://www.instagram.com/reel/DNhCJ0ghS36/' },
  { id: 'DCmMdX3NIjq', url: 'https://www.instagram.com/reel/DCmMdX3NIjq/' },
  { id: 'DEYIFlHIW5-', url: 'https://www.instagram.com/reel/DEYIFlHIW5-/' },
  { id: 'DES42lTuPFe', url: 'https://www.instagram.com/reel/DES42lTuPFe/' },
  { id: 'DPjGH_uAAtk', url: 'https://www.instagram.com/reel/DPjGH_uAAtk/' },
  { id: 'DFvYXoKym1u', url: 'https://www.instagram.com/reel/DFvYXoKym1u/' },
]
...
const TECHNIQUES = [
  {
    ...
    desc: 'Pause on frame one. Mute the video. If someone who has never heard of you saw only that image, would they feel anything? If the answer is no, the hook is already failing before a word is spoken.',
  },
  {
    n: 2,
    name: 'The Interruption Visual',
    desc: "Something in the frame that doesn't belong. An unexpected environment, an unusual object, a look on someone's face that doesn't match the setting. You notice it before you decide to. That's what buys the next two seconds.",
  },
  {
    n: 3,
    name: 'Tight Framing',
    desc: 'Close-up shots feel intimate and urgent. Wide shots feel like context. Almost every scroll-stopping hook opens tight: face filling most of the frame, eyes near the upper third. The closer you get, the harder it is to look away.',
  },
  {
    n: 4,
    name: 'On-Screen Text Timing',
    desc: 'Text that appears before the voiceover has more stopping power than text that chases the speech. When someone reads before they hear, they have already committed to the first half-second. That commitment tends to compound.',
  },
  {
    n: 5,
    name: 'Direct Camera Address',
    desc: 'Looking straight into the lens creates a different effect than looking just off-camera. Direct address feels confrontational in the best way. It reads as: this is for you, specifically. Looking away reads as: you are watching something that was not meant for you.',
  },
  {
    n: 6,
    name: 'The Unresolved Scene',
    desc: "Starting in the middle of something already in progress. You don't know what happened before, and you want to know how it ends. The hook doesn't explain what's happening. That explanation is the rest of the video.",
  },
  {
    n: 7,
    name: 'Visual Contrast',
    desc: "A person in an unexpected setting. Expression that doesn't match the environment. Text that contradicts what you see. Contrast within the frame creates a tension your eye wants to resolve. Sameness gets scrolled. Contrast gets paused.",
  },
]
      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          ;(async () => {
            ...
            const cu = new CountUp(el, value, { duration: value * 0.18, separator: '', startVal: 1, useEasing: false })
...
function VideoCard({ reel, index, isPlaying, onPlay }: {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ delay: (index % 4) * 0.07, scale: { type: 'spring', stiffness: 280, damping: 22 } }}
      className="relative rounded-2xl overflow-hidden border border-white/[0.08] bg-white/[0.03] cursor-pointer group"
      style={{ aspectRatio: '9/16', maxHeight: 460, zIndex: isPlaying ? 10 : 0 }}
      onClick={togglePlay}
    >
      <video
        ref={videoRef}
      ...
      <div className="absolute bottom-0 left-0 right-0 px-3 py-2.5 bg-gradient-to-t from-black/75 to-transparent flex items-center justify-between">
        <span className="text-white/65 text-xs font-medium">Example {index + 1}</span>
        <a
          href={reel.url}
          target="_blank"
      ...
      >
        <div className="px-6 sm:px-14 pb-12 pt-8 text-center">
          ...
          <p className="text-[#FCF4EB]/52 max-w-xl mx-auto mb-8 leading-relaxed text-base sm:text-lg">
            A small group of business owners who meet every week to actually build things. Not just study them. We go from watching what works to having a system that runs it, usually in one session.
          </p>
      ...
      <div className="min-h-screen bg-[#151515] text-[#FCF4EB] overflow-x-hidden">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 pb-4 pt-6 sm:pt-8">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="aurora-a absolute top-[10%] left-[15%] w-[320px] h-[320px] sm:w-[500px] sm:h-[500px] md:w-[600px] md:h-[600px] rounded-full opacity-[0.09]"
              style={{ background: 'radial-gradient(circle, #8B79D4 0%, transparent 70%)', filter: 'blur(80px)' }} />
            <div className="aurora-b absolute top-[30%] right-[10%] w-[280px] h-[280px] sm:w-[420px] sm:h-[420px] md:w-[500px] md:h-[500px] rounded-full opacity-[0.07]"
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto px-4">
            ...
            >
              Most people think about what to say. This is about what to show. Seven visual techniques that keep showing up in scroll-stopping reels, with real examples to study frame by frame.
            </motion.p>
            ...
            >
              {[
                ...
                { value: REELS.length, label: 'Reel Examples' },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 14 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.45, delay: 2.0 + i * 0.1 }}
                  className="glow-card bg-white/[0.04] border border-white/[0.08] rounded-2xl px-12 py-6 text-center min-w-[140px]"
                >
                  <CountUpNum
                    value={stat.value}
                    className="block text-5xl sm:text-6xl font-extrabold tabular-nums text-transparent bg-clip-text bg-gradient-to-r from-[#9D8FE0] to-[#F5C3C6]"
                  />
                  <div className="text-[#FCF4EB]/38 text-xs uppercase tracking-widest mt-2">{stat.label}</div>
                </motion.div>
              ))}
            </motion.div>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-6 py-14">
          ...
          >
            ...
            <p className="text-[#FCF4EB]/50 max-w-2xl mx-auto leading-relaxed">
              Most people scroll with sound off. The first couple of frames hit before anyone decides to stay or keep going. Learning to see what makes those frames work is a visual skill, not a writing skill.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                body: 'More than half of Instagram users scroll without sound. The hook has to work as a still image before it works as anything else.',
              },
              {
                icon: '◈',
                title: 'Frame one is a billboard',
                body: 'The first frame is a static image in the feed, competing with everything else in the scroll. Treat it like a billboard. Not a film opening.',
              },
              {
                icon: '✦',
                title: 'Motion earns the next second',
                body: 'Once someone pauses, the first motion either confirms they made the right call or tells them they were tricked. The visual has to match whatever the first frame promised.',
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <section className="relative z-10 max-w-6xl mx-auto px-6 py-14">
          ...
          >
            ...
            <div className="mb-4">
              <h2
                className="text-transparent bg-clip-text bg-gradient-to-r from-[#9D8FE0] to-[#F5C3C6]"
                style={{
                  fontFamily: '"Cormorant Garamond", Georgia, serif',
                  fontStyle: 'italic',
                  fontWeight: 700,
              ...
              >
                <CountUpNum value={REELS.length} /> reels to study
              </h2>
            </div>
            <p className="text-[#FCF4EB]/45 max-w-xl mx-auto leading-relaxed">
              Watch each one and see what you can spot. Pause on frame one. Watch the first three seconds twice before you watch the rest.
            </p>
          </motion.div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-8 px-2" style={{ overflow: 'visible' }}>
            {REELS.map((reel, i) => (
              <VideoCard
                key={reel.id}
                reel={reel}
          ...
          >
            <p className="text-[#FCF4EB]/60 text-sm leading-relaxed">
              These are examples of what has worked for other creators, not a formula you need to copy. Watch them, pull what feels useful, and leave the rest. What actually stops the scroll is authenticity. You have to find what that looks like for you, because everyone's version of it is different.
            </p>
          </motion.div>
        </section>
        ...
        <section className="relative z-10 max-w-5xl mx-auto px-6 py-14">
          ...
          >
            ...
            <p className="text-[#FCF4EB]/45 max-w-xl mx-auto leading-relaxed">
              Every scroll-stopping reel uses at least one of these. Most of them use three or more. Watch the reels above and see how many you can spot.
            </p>
          </motion.div>
                ...
                {[
                  {
                    ...
                    body: 'Before you press play: what does the thumbnail tell you? Is it a person, a setting, an action? Does anything look out of place? What does the first frame alone make you feel?',
                  },
                  {
                    q: '02',
                    title: 'Watch the first 3 seconds, no sound',
                    body: 'Mute it and watch the opening. Does it still hold your attention? What visual event happens, and when? Is there text, and does it land before or after the motion starts?',
                  },
                  {
                    q: '03',
                    title: 'Name the technique',
                    body: 'Which of the seven techniques does this one use? Most use more than one. Write them down. The ones that keep showing up across multiple reels are worth paying attention to.',
                  },
                  {
                    q: '04',
                    title: 'Could you reproduce this?',
                    body: 'Not the topic. The visual structure. Could you film something with the same framing, the same text timing, the same contrast? If yes, you have pulled a real template out of someone else\'s work.',
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
