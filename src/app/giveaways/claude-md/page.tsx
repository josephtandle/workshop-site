...
function FileActionButtons({ fileContent, onAfterCopy }: { fileContent: string; onAfterCopy?: () => void }) {
  ...
  return (
    <div className="mt-5 flex flex-col sm:flex-row justify-center gap-3">
      ...
      <button
        onClick={handleCopy}
        className="inline-flex items-center justify-center gap-2.5 px-10 py-4 rounded-xl bg-[#8B79D4] hover:bg-[#6B5AB8] text-white font-semibold text-base active:scale-[0.97] glow-btn shadow-xl shadow-[#8B79D4]/25"
      >
        {copied ? (
          <>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
