              ...
              {COMPATIBLE_TOOLS.map((tool) => (
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      background: tool.badge === 'Agent install' ? 'rgba(139,121,212,0.18)' : 'rgba(255,255,255,0.06)',
                      color: tool.badge === 'Agent install' ? '#9D8FE0' : '#FCF4EB44',
                      border: tool.badge === 'Agent install' ? '1px solid rgba(139,121,212,0.3)' : '1px solid rgba(255,255,255,0.08)',
                    }}
                  >
                    {tool.badge}
                  </span>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-16 h-16 rounded-full overflow-hidden border border-[#8B79D4]/25 flex-shrink-0">
                    <Image
                      src={t.photo}
                      alt={t.name}
                      width={64}
