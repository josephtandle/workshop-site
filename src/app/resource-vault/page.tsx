        ...
        <div className="border border-t-0 border-white/[0.08] rounded-b-2xl overflow-hidden">
          <div className="px-8 py-12 sm:px-12 sm:py-16">
            ...
            <div className="mb-12">
              ...
              <a
                href="/resource-vault/meta-ads-access"
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[#FCF4EB] font-semibold text-base mb-1">Granting Someone Else Access to Your Meta Ads Manager</p>
                    <p className="text-[#FCF4EB]/45 text-xs mb-3">Step-by-step guide</p>
                    <p className="text-[#FCF4EB]/60 text-sm leading-relaxed">
                      Give an agency or team member permission to manage your Meta (Facebook &amp; Instagram) ads through Business Settings &mdash; partner ID, asset selection, and access levels &mdash; without handing over your login.
                    </p>
                  </div>
                  <div
              ...
              <a
                href="/resource-vault/google-ads-access"
                className="block rounded-2xl p-6 transition-all hover:scale-[1.01] mb-4"
                style={{
                  background: 'rgba(124, 105, 199, 0.07)',
                  border: '1px solid rgba(124, 105, 199, 0.22)',
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[#FCF4EB] font-semibold text-base mb-1">Granting Access to Google Ads</p>
                    <p className="text-[#FCF4EB]/45 text-xs mb-3">Step-by-step guide</p>
                    <p className="text-[#FCF4EB]/60 text-sm leading-relaxed">
                      Invite an agency or team member to manage your Google Ads account at the Admin level through Access and security. Covers both the new and older Google Ads layouts.
                    </p>
                  </div>
                  <div
                    className="flex-shrink-0 text-xs font-semibold px-3 py-1.5 rounded-full"
