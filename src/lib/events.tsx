    ...
    hosts: [
      {
        ...
        bio: [
          'Joe Che is a number one bestselling author in three categories across business and AI, the founder of 35 companies, and the builder of two AI companies, including All Sorted AI, a practical AI operating system for service-based small business owners.',
